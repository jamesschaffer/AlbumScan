...
**Secondary Actions (History, Camera, Close buttons):**
...
- **Position:** Floating over content (top right or bottom right)
...
**Document Accuracy:** This document has been enhanced and verified against the actual codebase implementation as of October 29, 2025.

**Files Verified:**
- `CameraView.swift` (camera interface, framing guide, error banner, button styles)

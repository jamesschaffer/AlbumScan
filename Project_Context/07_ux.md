...
**Design Principle:** Witty, self-aware, personality-driven with progressive messaging to reduce perceived wait time

**Current Messages (Four-Stage Experience):**
- **State 1a (Identifying 0-3.5s):** "Extracting text and examining album art..."
- **State 1b (Identifying 3.5s+):** "Flipping through every record bin in existence..."
...
**Animation:**
- Ellipsis dots cycle 1 → 2 → 3 every 0.5 seconds on states 1a, 1b, and 3
- Slide-out transition (0.3s) when changing between messages
- Fade-in (0.4s) when new message appears
- Gives impression of ongoing work
- Dynamic text (album/artist names) in brand green

**UX Improvement:**
- Breaking ID Call 1 into two messages (1a → 1b at 3.5s mark)
- Reduces perceived wait time by showing progress
- First message (1a) is more technical and specific
- Second message (1b) is more playful and engaging
- Transition maintains engagement during longest processing step
...
- Progressive messaging provides variety and prevents boredom
